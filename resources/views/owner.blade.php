            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <!--li class="active">
                            <a href="{{ route('tenant') }}">
                                <i class="fas fa-file-alt"></i>Volantes</a>
                        </li>
                        <li>
                        <a href="{{ route('tenant') }}">
                        ...
                        <li>
                            <a href="{{ route('tenant') }}">
                                <i class="fas fa-money-check"></i>Facturas</a>
                        </li>
                        <li>
                            <a href="{{ route('tenant') }}">
                                <i class="fas fa-check-double"></i>Extractos</a>
                        </li>
                        <li>
                            <a href="{{ route('tenant') }}">
                                <i class="fas fa-file-invoice"></i>Certificaciones</a>
                        </li>
                        <!--li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-copy"></i>Pages</a>
