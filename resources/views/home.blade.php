...
<body class="animsition">
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" id="btn_cargar" class="btn btn-primary btn-sm">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table id="dt_files" class="table table-borderless table-data3">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>USUARIO</th>
    ...
    <script>
        ...
        $('#btn_cargar').on('click', function (e) {
            var files_data = $('#file-multiple-input').prop('files')[0];
            if (files_data != null) {
                var form_data = new FormData();
                form_data.append('id_user', {{ Auth::user()->id }});
                form_data.append('filenames', files_data);
                $.ajax({
                    type        : "POST",
                ...
                $.notify("Debe seleccionar un archivo.", "warn");
            }
        });

        function NotificationUserNew() {
            $.ajax({
                type: "POST",
                url : "{{ route('home/notificationUserNew') }}",
                data: {
        ...
        /*$("#file-multiple-input").change(function () {
            ...
            let TotalImages = $("#file-multiple-input")[0].files.length;  //Total Images
            let images = $("#file-multiple-input")[0];
        ...
        $("#dt_files").on("click", ".btn-danger[data-remote]", function (e) {
            var id_file = $(this).data("remote");
            $.ajax({
                type: "POST",
                url : "{{ route('home/deleteInfoFile') }}",
                data: {
                    "_token"    : $("input[name=_token]").val(),
                    "id_file"   : id_file,
                },
